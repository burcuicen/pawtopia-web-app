...
export const PAW_SEEKER_STEPS = [
  {
    ...
    options: [
      ...
      {
        key: "looking-guardian",
        label: "I'm looking for a new home for my paw friend!",
      },
...
export const PAW_GUARD_STEPS = [
  ...
  },
  {
    ...
    type: "paw-guard",
    description:
      "If you're comfortable sharing, what's the reason for finding a new home for your pet?",
