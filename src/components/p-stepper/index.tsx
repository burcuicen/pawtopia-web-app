  ...
  return (
    <div className="p-stepper__container">
      {stepArray.map((step, index) => {
        const circleClass = activeStep === step ? 'p-stepper__circle--active' : activeStep > step ? 'p-stepper__circle--done' : ''

        return (
          <React.Fragment key={step}>
            <div className={`p-stepper__circle ${circleClass}`} onClick={() => onStepChange(step)}>
